const CryptoJS = require('crypto-js'); // 这个包需要单独安装 npm install crypto-js
...
function a(a) {
    ...
    function encrypt_params(d, e, f, g) {
        var h = {}
          , i = a(16);
...
var p1 = '{"ids":"[1844933360]","level":"standard","encodeType":"aac","csrf_token":""}'
var p2 = '010001'
