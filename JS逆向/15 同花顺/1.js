var TOKEN_SERVER_TIME = 1711426533.546;
var document = {}
var window = {}
var cookiesV = this
!function (n, t) {
        ...
        !function (n) {
            ...
            function P() {
                ...
                S = new qn([a, a, a, a, n, n, n, e, t, t, t, t, t, t, t, a, t, n]),
                    // S[p] = Jn.serverTimeNow(), // 固定值 1711426533
                    S[p] = 1711426533, // 固定值 1711426533
                    M(),
                    S[B] = Vn,
                    S[k] = Un,
                    S[R] = c[2],
                    //S[h] = Jn.strhash(navigator.userAgent), // navigator.userAgent 也是dom操作，控制台打印固定值可替换,下面tt.xx都是固定值
                    S[h] = 4173916359
                S[b] = 3748,
                    S[g] = 1,
                    S[w] = 10,
