...
var noncestr= getNonceStr(8,'number')
var pageNum = 2
var pageSize = 100
var sectionCode = 0
var appSignKey = '4bTogwpz7RzNO2VTFtW7zcfRkAE97ox6ZSgcQi7FgYdqrHqKB7aGqEZ4o7yssa2aEXoV3bQwh12FFgVNlpyYk2Yjm9d2EZGeGu3' //这是调试中固定的
var data = `appSignKey=${appSignKey}&noncestr=${noncestr}&pageNum=${pageNum}&pageSize=${pageSize}&sectionCode=${sectionCode}&serverTimestamp=${timestamp-1}&timestamp=${timestamp}`
